...
```python
def compararCadenasASCI(cadena1, cadena2):
    valor_total_1 = 0
    for caracter in cadena1:
        valor_total_1 += ord(caracter)
    valor_total_2 = 0
    for caracter in cadena2:
        valor_total_2 += ord(caracter)

    if valor_total_1 > valor_total_2:
        print(valor_total_1)
        return cadena1
    elif valor_total_2 > valor_total_1:
        print(valor_total_2)
        return cadena2
    else:
        return f"Ambas cadenas {cadena1} y {cadena2} tienen el mismo valor total ASCII: {valor_total_1}"
    
print(compararCadenasASCI("Hola buenas","Hola buenass"))
```
